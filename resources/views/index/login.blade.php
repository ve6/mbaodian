...
<script src="js/push.js"></script><script src="js/rt.js" async="" type="text/javascript"></script><script type="text/javascript">
      ...
      var OP_CONFIG={"module":"user","page":"setprofile","userInfo":{"uid":3116765,"nickname":"qq_\u672c\u5bab\u672a\u6b7b\u4f11\u60f3\u7eb3\u59be_03116765","head":"http:\/\/img.mukewang.com\/user\/56f9e5ab0001e7b101000100-80-80.jpg","usertype":"1","roleid":0}};
  var isLogin = 1;
var is_choice = "";
...
<div id="setting-profile" class="setting-wrap setting-profile">
    <form id="profile">
        ...
        <div class="wlfg-wrap clearfix">
            ...
            <div class="rlf-group">
                <input name="nickname" id="nick" autocomplete="off" data-validate="nick" class="input rlf-input rlf-input-nick" value="qq_本宫未死休想纳妾_03116765" placeholder="请输入昵称." type="text">
        ...
        <div class="wlfg-wrap clearfix">
            ...
            <div class="rlf-group profile-address">
                <select id="province-select" class="input" hidefocus="true">
                    <option selected="selected" value="0">选择省份</option>
...
</script><script src="user_files/h.txt" type="text/javascript"></script><a href="http://tongji.baidu.com/hm-web/welcome/ico?s=f0cfcccd7b1393990c78efdeebff3968" target="_blank"><img src="picture/21.gif" height="20" width="20" border="0"></a>
<script>
(function(){
...
</div><script src="user_files/user.htm" type="text/javascript"></script><script src="picture/iplookup.php" type="text/javascript"></script>
