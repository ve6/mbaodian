    ...
    <div class="mainNavs">
        <?php foreach($all as $key=>$value): ?>                                                                                        
            ...
            <div class="menu_main job_hopping">
                ...
                <?php foreach($value['two'] as $ke=>$va): ?>
             <a href="#" data-lg-tj-id="4A00" data-lg-tj-no="0001" data-lg-tj-cid="idnull" style=" font-size:14px; padding-left:3px; line-height:20px;" val="<?php echo e($va['three'][0]['p_name']); ?>" class="posi"><?php echo e($va['three'][0]['p_name']); ?></a>
             <?php endforeach; ?>                                                    
              </div>
                    ...
                    <?php foreach($value['two'] as $k=>$v): ?>
                                <dl>
                                        <dt>                                                          
                        <a href="#" data-lg-tj-id="4H00" data-lg-tj-no="0001" data-lg-tj-cid="idnull" class="posi" val="<?php echo e($v['p_name']); ?>"><?php echo e($v['p_name']); ?></a>
                    </dt>
                    <dd>       
                    <?php foreach($v['three'] as $z=>$x): ?>                                                          
       <a href="#" data-lg-tj-id="4O00" data-lg-tj-no="0122" data-lg-tj-cid="idnull" class="posi" val="<?php echo e($x['p_name']); ?>"><?php echo e($x['p_name']); ?></a>
                    <?php endforeach; ?>
                                            </dd>
                </dl>
                    <?php endforeach; ?>    
