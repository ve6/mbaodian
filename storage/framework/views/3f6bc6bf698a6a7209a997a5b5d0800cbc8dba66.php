                ...
                <li class="set_btn user-card-box">
                    ...
                    <div class="g-user-card">
                        <div class="card-inner">
                            <div class="card-top">
                                <a href="user/setprofile"><img class="l" alt="<?php echo e(Session::get('username')); ?>" src="/<?php
                                    if(Session::get('user_filedir')){
                                        echo Session::get('user_filedir');
                                    }else{
                                        echo "images/unknow-160.png";
                                    };?>"></a>
                                <a href="user/setprofile"><span class="name text-ellipsis"><?php echo e(Session::get('username')); ?></span></a>
                                <?php /*经验||积分start*/ ?>
                                <p class="meta">
					<a href="/u/3071208/experience">经验<b id="js-user-mp">550</b></a>
					<a href="/u/3071208/credit">积分<b id="js-user-credit"><?php echo e(Session::get('u_score')); ?></b></a>
                                </p>
                                <?php /*经验||积分end*/ ?>
